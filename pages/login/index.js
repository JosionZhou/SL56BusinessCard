...
Page({
  ...
  doAuth: function () {
    ...
    wx.getUserInfo({
      success: res => {
        ...
        var url = app.globalData.authServerAddress + "/WeChatAuth/OAuth5";
  ...
  getAuthInfo: function (jumpUrl) {
    var data = {
      url: app.globalData.authServerAddress + "/WeChatAuth/GetAuth5Info",
      data: {
        openId: app.globalData.openId
      },
      success: function (res) {
